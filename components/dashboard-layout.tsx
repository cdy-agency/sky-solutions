...
const navItems: Record<string, NavItem[]> = {
  admin: [
    ...
    { href: "/admin/intakes", label: "Intake Submissions", icon: <FileText className="h-4 w-4" /> },
    { href: "/admin/investments", label: "Investments", icon: <TrendingUp className="h-4 w-4" /> },
    { href: "/admin/expenses", label: "Expenses", icon: <DollarSign className="h-4 w-4" /> },
  ...
  entrepreneur: [
    ...
    { href: "/entrepreneur/businesses/select-type", label: "New Business", icon: <Building2 className="h-4 w-4" /> },
    { href: "/entrepreneur/intakes", label: "Intake Forms", icon: <FileText className="h-4 w-4" /> },
    { href: "/profile", label: "My Profile", icon: <Users className="h-4 w-4" /> },
  ],
  investor: [
    ...
    { href: "/investor/intakes", label: "Intake Forms", icon: <FileText className="h-4 w-4" /> },
    { href: "/profile", label: "My Profile", icon: <Users className="h-4 w-4" /> },
  ],
}
