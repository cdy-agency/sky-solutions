    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link href="/register" className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition">
            <Mail size={20} />
            Continue with Email
          </Link>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link
              href="/register"
              className="flex items-center justify-center gap-3 px-6 py-3 bg-white bg-opacity-10 text-white rounded-lg font-semibold hover:bg-opacity-20 transition border border-white border-opacity-20"
            >
              <Facebook size={20} />
