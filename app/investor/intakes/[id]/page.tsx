...
export default function InvestorIntakeDetailPage() {
  const { id } = useParams()
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-foreground">Investor Intake Form</h1>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium capitalize">{intake.form_type}</p>
              </div>
              <div>
